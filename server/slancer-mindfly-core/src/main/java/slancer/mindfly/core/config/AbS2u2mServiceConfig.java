package slancer.mindfly.core.config;
...
import slancer.mindfly.core.config.cors.S2u2mCorsConfig;
import slancer.mindfly.core.config.cors.S2u2mCorsRegistration;
